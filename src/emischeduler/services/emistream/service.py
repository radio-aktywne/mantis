...
from emischeduler.services.emistream import models as m
...
class BaseService(Gracy[Endpoint]):
    """Base class for emistream service."""
...
class CheckNamespace(GracyNamespace[Endpoint]):
    """Namespace for emistream check endpoint."""
...
class ReserveNamespace(GracyNamespace[Endpoint]):
    """Namespace for emistream reserve endpoint."""
...
class SSENamespace(GracyNamespace[Endpoint]):
    """Namespace for emistream sse endpoint."""
