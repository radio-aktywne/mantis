...
from emischeduler.models.base import SerializableModel, datamodel, serializable
from emischeduler.utils.time import NaiveDatetime, Timezone
...
EventsListRequestLimit = int | None

EventsListRequestOffset = int | None

EventsListRequestWhere = EventWhereInput | None

EventsListRequestInclude = EventInclude | None

EventsListRequestOrder = EventOrderByInput | list[EventOrderByInput] | None

EventsListResponseResults = EventList
...
class EventsListRequest:
    ...
    include: EventsListRequestInclude
    """Relations to include in the response."""

    order: EventsListRequestOrder
    """Order to apply to the results."""
