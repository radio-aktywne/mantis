...
ENV EMISCHEDULER_DB___HOST=localhost \
    EMISCHEDULER_DB__PORT=32000 \
    EMISCHEDULER_DB__PASSWORD=password \
    EMISCHEDULER_ADMIN__PORT=33000 \
    EMISCHEDULER_ADMIN__USERNAME=admin \
    EMISCHEDULER_ADMIN__PASSWORD=password \
